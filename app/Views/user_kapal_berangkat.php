...
<head>
  ...
  <title>Data Kapal Berangkat | PPN Merauke</title>
      ...
      <?php if (!empty($kapal)) : ?>
        <?php $no = 1; foreach ($kapal as $k) : ?>
          <tr>
            ...
            <td><?= date('d M Y', strtotime($k['tanggal_berangkat'])) ?></td>
            <td><span style="color:green;font-weight:600;">BERLAYAR</span></td>
          </tr>
        <?php endforeach; ?>
      <?php else : ?>
        <tr><td colspan="5">Tidak ada data kapal berangkat.</td></tr>
      <?php endif; ?>
    </table>
  </main>
